...
class WithdrawApplyService extends \common\services\WithdrawApplyService
{
     ...
     */
    public static function createDistributeBalanceWithdrawApplyA($bizId, $bizType, $amount, $type, $userId, $userName, $openId,$remark){
        ...
        ExceptionAssert::assertTrue($bizType==BizTypeEnum::BIZ_TYPE_HA,StatusCode::createExpWithParams(StatusCode::WITHDRAW_ERROR,"bizError"));
