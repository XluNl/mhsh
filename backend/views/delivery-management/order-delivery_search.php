...
/* @var $model backend\models\forms\OrderDeliverySearchForms */
                ...
                echo FormGrid::widget([
                    ...
                    'rows' => [
                        ...
                        [
                            ...
                            'autoGenerateColumns' => false, // override columns setting
                            'attributes' => [       // 3 column layout
                                'less_goods_num' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => '输入少于配送的商品数量...'], 'columnOptions' => ['colspan' => 3]],
                                'less_goods_amount' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => '输入少于配送的商品金额...'], 'columnOptions' => ['colspan' => 3]],
                            ]
                        ],
                    ]
                ]);
