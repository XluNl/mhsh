...
//                        'em_phone',
                        [
                            ...
                            'value' => function ($data) {
                                ...
                                return substr_replace($data['em_phone'],'****',3,4);
                            },
                        ],
                        'occupation',
                        [
                        ...
                        [
                            ...
                            'template' => '{update}|{enable}{disable}{invite}{coupon}{draw}{delete}',
                            ...
                            'buttons' =>[
                                ...
                                'delete' => function ($url, $model, $key) {
                                    return BackendViewUtil::generateOperationATag("删除用户",['/user-info/delete','id'=>$model['id']],'btn btn-xs btn-danger','fa fa-bookmark-o');
                                },
                            ],
                        ],
                    ],
