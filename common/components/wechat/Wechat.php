 ...
 * Class Wechat
 *
 * @package backend\components\wechat
 *
...
class Wechat extends Component
{
     ...
     * @var string
     */
    public $configPrefix = "defaultWechat";
    /**
    ...
    public function getApp()
    {
        ...
        {
            self::$_app = Factory::officialAccount(Yii::$app->params[$this->configPrefix]['wechatConfig']);
        }
    ...
    public function getPayment()
    {
        ...
        {
            self::$_payment = Factory::payment(Yii::$app->params[$this->configPrefix]['wechatPaymentConfig']);
        }
    ...
    public function getMiniProgram()
    {
        ...
        {
            self::$_miniProgram = Factory::miniProgram(Yii::$app->params[$this->configPrefix]['wechatMiniProgramConfig']);
        }
    ...
    public function getOpenPlatform()
    {
        ...
        {
            self::$_openPlatform = Factory::openPlatform(Yii::$app->params[$this->configPrefix]['wechatOpenPlatformConfig']);
        }
    ...
    public function getWork()
    {
        ...
        {
            self::$_work = Factory::work(Yii::$app->params[$this->configPrefix]['wechatWorkConfig']);
        }
    ...
    public function getOpenWork()
    {
        ...
        {
            self::$_openWork = Factory::openWork(Yii::$app->params[$this->configPrefix]['wechatOpenWorkConfig']);
        }
