...
class AdminUser extends ActiveRecord implements IdentityInterface
{
    ...
    public static $superAdminArr=[
        self::SUPER_ADMIN_YES=>'是',
        self::SUPER_ADMIN_NO=>'否',
    ];
    public static $superAdminCssArr=[
        self::SUPER_ADMIN_YES=>'label label-success',
        self::SUPER_ADMIN_NO=>'label label-warning',
    ];
